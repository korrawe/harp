...
class ManoLayer(Module):
    ...
    def forward(self,
        ...
        if self.use_pca or self.joint_rot_mode == 'axisang':
            ...
            # print("rot", th_pose_coeffs[:, :self.rot])
            # print("th_full_pose", th_full_pose)
            # print("th_full_pose", th_full_pose.shape)
        ...
        # print("no_rot", torch.eye(3).repeat(batch_size, 1, 1))
        if no_root_rot:
        ...
        # print("root_j", root_j)
        # print("root transformation", root_trans)
        ...
        # print("th_2", th_results2.permute(0, 3, 1, 2)[0,:3])
        ...
        th_jtr = th_jtr[:, [0, 13, 14, 15, 16, 1, 2, 3, 17, 4, 5, 6, 18, 10, 11, 12, 19, 7, 8, 9, 20]]  #NOTE:might need this
        ...
        # mesh vertices, joints, trans_matrix, rest_pose_vertices, rest_post_joints
        # return th_verts, th_jtr, trans_matrix, th_v_posed, th_j, th_results2.permute(0, 3, 1, 2)
