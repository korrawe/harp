...
if __name__ == "__main__":
    ...
    # initial query point cloud with 2 point at [0.5,0.5,1], [1,1,1]
    points = torch.tensor([[[0.5, 0.5, 1.0], [1.0, 1.0, 1.0]]]).to('cuda')
    point_cloud = Pointclouds(points)

    # compute point to mesh distance
    dist = point_mesh_face_distance(mesh, point_cloud)
